...
public final class GameScreen implements Screen {
    ...
    public com.mygdx.game.gui.board.GameBoard getGameBoard() {
        return this.gameBoard;
    }

    public com.mygdx.game.gui.board.GameBoard.DisplayOnlyBoard getDisplayOnlyBoard() {
        return this.displayOnlyBoard;
    }

    public com.mygdx.game.gui.moveHistory.MoveHistory getMoveHistory() {
        return this.moveHistory;
    }

    public com.mygdx.game.gui.timer.TimerPanel getGameTimerPanel() {
