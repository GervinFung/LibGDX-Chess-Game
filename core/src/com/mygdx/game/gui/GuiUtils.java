...
public final class GuiUtils {
    ...
    private GuiUtils() { throw new RuntimeException("Cannot instantiate GUI_UTILS"); }

    //dialog
    public final static boolean IS_SMARTPHONE = Gdx.app.getType() == Application.ApplicationType.Android || Gdx.app.getType() == Application.ApplicationType.iOS;
    public final static int PAD = 20;
    public final static int WIDTH = IS_SMARTPHONE ? 150 : 300;
    ...
    public enum TILE_COLOR {
        ...
        DARK_GRAY{
            ...
            @Override
            public Color HIGHLIGHT_LEGAL_MOVE_LIGHT_TILE() { return new Color(1, 252/255f, 84/255f, 0.95f); }
        },
