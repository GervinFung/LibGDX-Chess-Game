package com.mygdx.game.GUI.board.moveHistory;
...
public final class MoveHistory extends Table {
    ...
    private final static int SIZE = GUI_UTILS.GAME_BOARD_SR_SIZE / 2;
    ...
    public MoveHistory() {
        ...
        this.whiteTakenPiece = new MoveHistory.TakenPiece(League.WHITE, GUI_UTILS.WHITE_CAPTURED);
        this.blackTakenPiece = new MoveHistory.TakenPiece(League.BLACK, GUI_UTILS.BLACK_CAPTURED);
        ...
        private void updateMoveHistory(final MoveHistory moveHistory) {
            ...
            for (final Move move : moveHistory.moveLog.getMoves()) {
                ...
                if ((j % 2 != 0 && i % 2 != 0) || (j % 2 == 0 && i % 2 == 0)) {
                    table.setBackground(GUI_UTILS.MOVE_HISTORY_1);
                } else {
                    table.setBackground(GUI_UTILS.MOVE_HISTORY_2);
                }
    ...
    private final static class TakenPiece extends Table {
        ...
        private void addTakenPiece(final HashMap<Piece, Integer> takenPiecesMap) {
            ...
            for (final Piece takenPiece : takenPieces) {
                this.add(new Image(GUI_UTILS.GET_PIECE_TEXTURE_REGION(takenPiece))).size(40, 40);
                final Label label = new Label(Integer.toString(takenPiecesMap.get(takenPiece)), GUI_UTILS.UI_SKIN);
                label.setSize(10, 10);
                this.add(label);
            }
        }
