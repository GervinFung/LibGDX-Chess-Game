...
public final class GameOption extends TextButton {
    ...
    private static final class GameOptionDialog extends Dialog {
        ...
        private GameOptionDialog(final GameScreen gameScreen) {
            ...
            this.getContentTable().add(new HighlightLegalMove(gameScreen)).align(Align.left).padBottom(20).row();
            this.getContentTable().add(new ShowPreviousMove(gameScreen)).align(Align.left).padBottom(20).row();
            this.getContentTable().add(new PauseTimer(gameScreen)).align(Align.left).padBottom(20).row();
