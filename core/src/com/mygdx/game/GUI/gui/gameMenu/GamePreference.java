...
public final class GamePreference extends TextButton {
    ...
    private static final class GamePreferenceDialog extends Dialog {
        ...
        private GamePreferenceDialog(final GameScreen gameScreen) {
            ...
            this.getContentTable().add(new FlipBoardButton(gameScreen, this)).width(WIDTH).padBottom(PAD).padRight(PAD);
            this.getContentTable().add(new BoardColorButton(gameScreen, this)).width(WIDTH).padBottom(PAD).row();
            this.getContentTable().add(new ExportFEN(gameScreen, this)).width(WIDTH).padBottom(PAD).padRight(PAD);
            this.getContentTable().add(new ImportFEN(gameScreen, this)).width(WIDTH).padBottom(PAD).row();
            this.undoButton = new UndoButton(gameScreen, this);
            this.getContentTable().add(this.undoButton).width(WIDTH).padRight(PAD);
            this.getContentTable().add(new CancelButton(gameScreen, this)).width(WIDTH);
        }
    ...
    private final static class UndoButton extends TextButton {
        ...
        private UndoButton(final GameScreen gameScreen, final GamePreferenceDialog gamePreferenceDialog) {
            super(IS_SMARTPHONE ? "Undo Move" : "Undo Move (CTRL + Z)", GUI_UTILS.UI_SKIN);
