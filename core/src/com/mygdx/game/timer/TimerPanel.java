...
public final class TimerPanel extends Table {
    ...
    public final static int SIZE = GUI_UTILS.UTILS.GAME_BOARD_SR_SIZE / 2;
    ...
    public void continueTimer(final boolean stopTimer) { this.continueTimer = stopTimer; }
    ...
    private final static class PlayerTimerTable extends Table {
        ...
        private PlayerTimerTable(final Color panelColor, final Color labelColor, final CharSequence text) {
            ...
            final Label label = new Label(text + " Timer", GUI_UTILS.UTILS.UI_SKIN);
            label.setColor(labelColor);
            this.add(label).row();
            this.timerLabel = new Label(this.getTimeFormat(BoardUtils.UTILS.DEFAULT_TIMER_MINUTE, BoardUtils.UTILS.DEFAULT_TIMER_SECOND, BoardUtils.UTILS.DEFAULT_TIMER_MILLISECOND), GUI_UTILS.UTILS.UI_SKIN);
            this.timerLabel.setColor(labelColor);
            this.add(timerLabel);
            this.setVisible(true);
            this.setBackground(new NinePatchDrawable(new NinePatch(GUI_UTILS.UTILS.GET_TILE_TEXTURE_REGION("whitePixel"), panelColor)));
        }
