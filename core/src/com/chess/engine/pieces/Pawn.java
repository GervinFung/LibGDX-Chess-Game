        ...
        for (final int currentCandidateOFFSET : MOVE_VECTOR_COORDINATE) {
            ...
            if (currentCandidateOFFSET == 8 && !board.getTile(candidateDestinationCoordinate).isTileOccupied()) {
                ...
                if (this.league.isPawnPromotionSquare(candidateDestinationCoordinate) && this.isLegalMove(board, candidateDestinationCoordinate)) {
                    ...
                    ((BoardUtils.UTILS.SECOND_ROW.get(this.piecePosition) && this.getLeague().isBlack()) ||
                            (BoardUtils.UTILS.SEVENTH_ROW.get(this.piecePosition) && this.getLeague().isWhite()))) {
                ...
                if (!board.getTile(behindCandidateDestinationCoordinate).isTileOccupied() &&
                    ...
                    !((BoardUtils.UTILS.EIGHTH_COLUMN.get(this.piecePosition) && this.league.isWhite()) ||
                            (BoardUtils.UTILS.FIRST_COLUMN.get(this.piecePosition) && this.league.isBlack()))) {
                if (board.getTile(candidateDestinationCoordinate).isTileOccupied()) {
                    ...
                    !((BoardUtils.UTILS.FIRST_COLUMN.get(this.piecePosition) && this.league.isWhite()) ||
                            (BoardUtils.UTILS.EIGHTH_COLUMN.get(this.piecePosition) && this.league.isBlack()))) {
                if (board.getTile(candidateDestinationCoordinate).isTileOccupied()) {
