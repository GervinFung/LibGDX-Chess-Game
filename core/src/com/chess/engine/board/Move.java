...
public abstract class Move implements Serializable {
    ...
    public static final class MajorMove extends Move {
        ...
        @Override
        public String toString() { return getMovedPiece().getPieceType().toString() + BoardUtils.UTILS.getPositionAtCoordinate(this.destinationCoordinate); }
    }
    ...
    public static final class MajorAttackMove extends AttackMove {
        ...
        @Override
        public String toString() { return getMovedPiece().getPieceType() + BoardUtils.UTILS.getPositionAtCoordinate(this.destinationCoordinate) + "x" + this.getAttackedPiece(); }
    }
    ...
    public static final class PawnMove extends Move {
        ...
        public String toString() {
            return BoardUtils.UTILS.getPositionAtCoordinate(this.destinationCoordinate);
        }
    ...
    public static class PawnAttackMove extends AttackMove {
        ...
        @Override
        public String toString() {
            return BoardUtils.UTILS.getPositionAtCoordinate(this.movePiece.getPiecePosition()).charAt(0) + "x" +
                    BoardUtils.UTILS.getPositionAtCoordinate(this.destinationCoordinate);
        }
    }
    ...
    public static final class PawnPromotion extends Move {
        ...
        public void startLibGDXPromotion(final MyGdxGame myGdxGame) {
            final Dialog promoteDialog = new Dialog("Pawn Promotion", GUI_UTILS.UTILS.UI_SKIN);
        ...
        private Button[] pawnPromotionButton(final MyGdxGame myGdxGame, final List<Piece> getPromotionPieces, final Dialog promoteDialog) {
            ...
            for (int i = 0; i < 4; i++) {
                buttons[i] = new Button(new TextureRegionDrawable(GUI_UTILS.UTILS.GET_PIECE_TEXTURE_REGION(getPromotionPieces.get(i))));
                final int finalI = i;
        ...
        @Override
        public String toString() { return BoardUtils.UTILS.getPositionAtCoordinate(this.destinationCoordinate) + "=" +this.promotedPiece.toString().charAt(0); }
    ...
    public static final class PawnJump extends Move {
        ...
        @Override
        public String toString() {
            return BoardUtils.UTILS.getPositionAtCoordinate(destinationCoordinate);
        }
    }
