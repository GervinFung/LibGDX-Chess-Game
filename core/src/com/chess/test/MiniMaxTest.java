...
public final class MiniMaxTest {
    ...
    public void testOpeningDepth4BlackMovesFirst() {
        ...
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "e7"), BoardUtils.UTILS.getCoordinateAtPosition("e5")));
    }
    ...
    public void advancedLevelProblem2NakamuraShirov() {
        ...
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "d5"), BoardUtils.UTILS.getCoordinateAtPosition("c7")));
    }
    ...
    public void testQualityTwoDepth6() {
        ...
        final MiniMax alphaBeta = new MiniMax(6);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "h4"), BoardUtils.UTILS.getCoordinateAtPosition("f4")));
    }
    ...
    public void testQualityThreeDepth6() {
        ...
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "g4"), BoardUtils.UTILS.getCoordinateAtPosition("g7")));
    }
    ...
    public void testQualityFourDepth6() {
        ...
        final MiniMax alphaBeta = new MiniMax(6);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "e8"), BoardUtils.UTILS.getCoordinateAtPosition("g8")));
    }
    ...
    public void eloTest2() {
        ...
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "h5"), BoardUtils.UTILS.getCoordinateAtPosition("g6")));
    }
    ...
    public void eloTest3() {
        ...
        final MiniMax alphaBeta = new MiniMax(6);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "g3"),BoardUtils.UTILS.getCoordinateAtPosition("g6")));
    }
    ...
    public void blackWidowLoss1() {
        ...
        final MiniMax alphaBeta = new MiniMax(6);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "c3"), BoardUtils.UTILS.getCoordinateAtPosition("d4")));
    }
    ...
    public void testCheckmateHorizon() {
        ...
        final MiniMax alphaBeta = new MiniMax(4);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "g2"), BoardUtils.UTILS.getCoordinateAtPosition("g4")));
    }
    ...
    public void testBlackInTrouble() {
        ...
        final MiniMax alphaBeta = new MiniMax(4);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "e4"), BoardUtils.UTILS.getCoordinateAtPosition("e8")));
    }
    ...
    public void findMate3() {
        ...
        final MiniMax alphaBeta = new MiniMax(6);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "f7"), BoardUtils.UTILS.getCoordinateAtPosition("h6")));
    ...
    public void runawayPawnMakesIt() {
        ...
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "a4"), BoardUtils.UTILS.getCoordinateAtPosition("a3")));
        final MoveTransition t1 = board.currentPlayer().makeMove(bestMove);
        assertTrue(t1.getMoveStatus().isDone());
    }
    ...
    public void testMackHackScenario() {
        ...
        final MiniMax alphaBeta = new MiniMax(8);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "f8"), BoardUtils.UTILS.getCoordinateAtPosition("f2")));
        final MoveTransition t1 = board.currentPlayer().makeMove(bestMove);
        assertTrue(t1.getMoveStatus().isDone());
    }
    ...
    public void testBratcoKopec1() {
        ...
        final MiniMax alphaBeta = new MiniMax(6);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "d6"), BoardUtils.UTILS.getCoordinateAtPosition("d1")));
        final MoveTransition t1 = board.currentPlayer().makeMove(bestMove);
        assertTrue(t1.getMoveStatus().isDone());
    }
    ...
    public void testTimeOut() {
        ...
        final Move whiteMove = MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "e2"), BoardUtils.UTILS.getCoordinateAtPosition("e4"));
